...
import Gomoku.WinnerChecker;
import Gomoku.WinnerResult;
import homeWork.DataUtils;
...
public class DefaultWinnerChecker implements WinnerChecker {
	...
	private static class DefaultWinnerResult implements WinnerResult {
		...
		DefaultWinnerResult(DataSet<Cell> winnerCells) {
			this.winnerCells = winnerCells; // thats not worked
			//this.winnerCells = winnerCells != null ? DataUtils.newImmutableDataSet(winnerCells)
